...
// source: googleadx.proto
// DO NOT EDIT!

/*
Package googleadx is a generated protocol buffer package.
...
type BidRequest struct {
	...
	UserDataTreatment []BidRequest_UserDataTreatment `protobuf:"varint,49,rep,name=user_data_treatment,enum=googleadx.BidRequest_UserDataTreatment" json:"user_data_treatment,omitempty"`
	...
	PublisherType           *BidRequest_PublisherType         `protobuf:"varint,51,opt,name=publisher_type,enum=googleadx.BidRequest_PublisherType,def=0" json:"publisher_type,omitempty"`
...
type BidRequest_Device struct {
	DeviceType *BidRequest_Device_DeviceType `protobuf:"varint,1,opt,name=device_type,enum=googleadx.BidRequest_Device_DeviceType,def=0" json:"device_type,omitempty"`
	...
	ScreenOrientation *BidRequest_Device_ScreenOrientation `protobuf:"varint,10,opt,name=screen_orientation,enum=googleadx.BidRequest_Device_ScreenOrientation,def=0" json:"screen_orientation,omitempty"`
...
type BidRequest_Video struct {
	Placement *BidRequest_Video_Placement `protobuf:"varint,16,opt,name=placement,enum=googleadx.BidRequest_Video_Placement,def=0" json:"placement,omitempty"`
	...
	PlaybackMethod    *BidRequest_Video_VideoPlaybackMethod `protobuf:"varint,14,opt,name=playback_method,enum=googleadx.BidRequest_Video_VideoPlaybackMethod,def=0" json:"playback_method,omitempty"`
	...
	VideoAdSkippable *BidRequest_Video_SkippableBidRequestType `protobuf:"varint,4,opt,name=video_ad_skippable,enum=googleadx.BidRequest_Video_SkippableBidRequestType,def=0" json:"video_ad_skippable,omitempty"`
	...
	Protocols               []BidRequest_Video_VideoProtocol    `protobuf:"varint,17,rep,packed,name=protocols,enum=googleadx.BidRequest_Video_VideoProtocol" json:"protocols,omitempty"`
	AllowedVideoFormats     []BidRequest_Video_VideoFormat      `protobuf:"varint,6,rep,name=allowed_video_formats,enum=googleadx.BidRequest_Video_VideoFormat" json:"allowed_video_formats,omitempty"`
	CompanionSlot           []*BidRequest_Video_CompanionSlot   `protobuf:"bytes,7,rep,name=companion_slot" json:"companion_slot,omitempty"`
	EndCapSupport           *BidRequest_Video_EndCapSupport     `protobuf:"varint,13,opt,name=end_cap_support,enum=googleadx.BidRequest_Video_EndCapSupport,def=0" json:"end_cap_support,omitempty"`
	...
	DEPRECATEDInventoryType *BidRequest_Video_InventoryType     `protobuf:"varint,3,opt,name=DEPRECATED_inventory_type,enum=googleadx.BidRequest_Video_InventoryType,def=0" json:"DEPRECATED_inventory_type,omitempty"`
	XXX_unrecognized        []byte                              `json:"-"`
}
...
type BidRequest_Video_CompanionSlot struct {
	...
	CreativeFormat   []BidRequest_Video_CompanionSlot_CreativeFormat `protobuf:"varint,3,rep,name=creative_format,enum=googleadx.BidRequest_Video_CompanionSlot_CreativeFormat" json:"creative_format,omitempty"`
	XXX_unrecognized []byte                                          `json:"-"`
}
...
type BidRequest_AdSlot struct {
	...
	SlotVisibility *BidRequest_AdSlot_SlotVisibility `protobuf:"varint,12,opt,name=slot_visibility,enum=googleadx.BidRequest_AdSlot_SlotVisibility,def=0" json:"slot_visibility,omitempty"`
	...
	IframingState       *BidRequest_AdSlot_IFramingState      `protobuf:"varint,19,opt,name=iframing_state,enum=googleadx.BidRequest_AdSlot_IFramingState,def=0" json:"iframing_state,omitempty"`
	IframingDepth       *BidRequest_AdSlot_IFramingDepth      `protobuf:"varint,20,opt,name=iframing_depth,enum=googleadx.BidRequest_AdSlot_IFramingDepth,def=0" json:"iframing_depth,omitempty"`
	...
	MediationStatus     *BidRequest_AdSlot_MediationStatus    `protobuf:"varint,52,opt,name=mediation_status,enum=googleadx.BidRequest_AdSlot_MediationStatus,def=0" json:"mediation_status,omitempty"`
	...
	NonBrowserSlotSource *BidRequest_AdSlot_NonBrowserSource `protobuf:"varint,34,opt,name=non_browser_slot_source,enum=googleadx.BidRequest_AdSlot_NonBrowserSource,def=0" json:"non_browser_slot_source,omitempty"`
	...
	Renderer           *BidRequest_AdSlot_Renderer         `protobuf:"varint,26,opt,name=renderer,enum=googleadx.BidRequest_AdSlot_Renderer,def=0" json:"renderer,omitempty"`
	AmpAdRequestType   *BidRequest_AdSlot_AmpAdRequestType `protobuf:"varint,29,opt,name=amp_ad_request_type,enum=googleadx.BidRequest_AdSlot_AmpAdRequestType,def=1" json:"amp_ad_request_type,omitempty"`
	...
	AllowedAdTypes   []BidRequest_AdSlot_AllowedAdType `protobuf:"varint,36,rep,packed,name=allowed_ad_types,enum=googleadx.BidRequest_AdSlot_AllowedAdType" json:"allowed_ad_types,omitempty"`
	XXX_unrecognized []byte                            `json:"-"`
}
...
type BidRequest_AdSlot_MatchingAdData_DirectDeal struct {
	...
	DealType       *BidRequest_AdSlot_MatchingAdData_DirectDeal_DealType `protobuf:"varint,3,opt,name=deal_type,enum=googleadx.BidRequest_AdSlot_MatchingAdData_DirectDeal_DealType,def=0" json:"deal_type,omitempty"`
...
type BidRequest_AdSlot_NativeAdTemplate struct {
	...
	StyleLayoutType *BidRequest_AdSlot_NativeAdTemplate_LayoutType `protobuf:"varint,17,opt,name=style_layout_type,enum=googleadx.BidRequest_AdSlot_NativeAdTemplate_LayoutType,def=0" json:"style_layout_type,omitempty"`
...
type BidRequest_AdSlot_AutoRefresh_AutoRefreshSettings struct {
	...
	RefreshType *BidRequest_AdSlot_AutoRefresh_AutoRefreshSettings_AutoRefreshType `protobuf:"varint,1,opt,name=refresh_type,enum=googleadx.BidRequest_AdSlot_AutoRefresh_AutoRefreshSettings_AutoRefreshType,def=0" json:"refresh_type,omitempty"`
...
type BidRequest_AdSlot_StickySettings struct {
	...
	VerticalStickiness *BidRequest_AdSlot_StickySettings_Stickiness `protobuf:"varint,1,opt,name=vertical_stickiness,enum=googleadx.BidRequest_AdSlot_StickySettings_Stickiness,def=0" json:"vertical_stickiness,omitempty"`
	// Whether the request originated from an ad slot that scrolls along with
	// the contents of the page horizontally, and is located at the top of the
	// page.
	TopHorizontalStickiness *BidRequest_AdSlot_StickySettings_Stickiness `protobuf:"varint,2,opt,name=top_horizontal_stickiness,enum=googleadx.BidRequest_AdSlot_StickySettings_Stickiness,def=0" json:"top_horizontal_stickiness,omitempty"`
	// Whether the request originated from an ad slot that scrolls along with
	// the contents of the page horizontally, and is located at the bottom of
	// the page.
	BottomHorizontalStickiness *BidRequest_AdSlot_StickySettings_Stickiness `protobuf:"varint,3,opt,name=bottom_horizontal_stickiness,enum=googleadx.BidRequest_AdSlot_StickySettings_Stickiness,def=0" json:"bottom_horizontal_stickiness,omitempty"`
	XXX_unrecognized           []byte                                       `json:"-"`
}
...
type BidResponse_Ad_AdSlot struct {
	...
	ExchangeDealType *BidResponse_Ad_AdSlot_ExchangeDealType `protobuf:"varint,7,opt,name=exchange_deal_type,enum=googleadx.BidResponse_Ad_AdSlot_ExchangeDealType,def=0" json:"exchange_deal_type,omitempty"`
	XXX_unrecognized []byte                                  `json:"-"`
}
...
func init() {
	proto.RegisterType((*BidRequest)(nil), "googleadx.BidRequest")
	proto.RegisterType((*BidRequest_Hyperlocal)(nil), "googleadx.BidRequest.Hyperlocal")
	proto.RegisterType((*BidRequest_Hyperlocal_Point)(nil), "googleadx.BidRequest.Hyperlocal.Point")
	proto.RegisterType((*BidRequest_HyperlocalSet)(nil), "googleadx.BidRequest.HyperlocalSet")
	proto.RegisterType((*BidRequest_UserList)(nil), "googleadx.BidRequest.UserList")
	proto.RegisterType((*BidRequest_Vertical)(nil), "googleadx.BidRequest.Vertical")
	proto.RegisterType((*BidRequest_Device)(nil), "googleadx.BidRequest.Device")
	proto.RegisterType((*BidRequest_Device_OsVersion)(nil), "googleadx.BidRequest.Device.OsVersion")
	proto.RegisterType((*BidRequest_KeyValue)(nil), "googleadx.BidRequest.KeyValue")
	proto.RegisterType((*BidRequest_Mobile)(nil), "googleadx.BidRequest.Mobile")
	proto.RegisterType((*BidRequest_Video)(nil), "googleadx.BidRequest.Video")
	proto.RegisterType((*BidRequest_Video_CompanionSlot)(nil), "googleadx.BidRequest.Video.CompanionSlot")
	proto.RegisterType((*BidRequest_Video_ContentAttributes)(nil), "googleadx.BidRequest.Video.ContentAttributes")
	proto.RegisterType((*BidRequest_AdSlot)(nil), "googleadx.BidRequest.AdSlot")
	proto.RegisterType((*BidRequest_AdSlot_MatchingAdData)(nil), "googleadx.BidRequest.AdSlot.MatchingAdData")
	proto.RegisterType((*BidRequest_AdSlot_MatchingAdData_BuyerPricingRule)(nil), "googleadx.BidRequest.AdSlot.MatchingAdData.BuyerPricingRule")
	proto.RegisterType((*BidRequest_AdSlot_MatchingAdData_DirectDeal)(nil), "googleadx.BidRequest.AdSlot.MatchingAdData.DirectDeal")
	proto.RegisterType((*BidRequest_AdSlot_ExchangeBidding)(nil), "googleadx.BidRequest.AdSlot.ExchangeBidding")
	proto.RegisterType((*BidRequest_AdSlot_NativeAdTemplate)(nil), "googleadx.BidRequest.AdSlot.NativeAdTemplate")
	proto.RegisterType((*BidRequest_AdSlot_AutoRefresh)(nil), "googleadx.BidRequest.AdSlot.AutoRefresh")
	proto.RegisterType((*BidRequest_AdSlot_AutoRefresh_AutoRefreshSettings)(nil), "googleadx.BidRequest.AdSlot.AutoRefresh.AutoRefreshSettings")
	proto.RegisterType((*BidRequest_AdSlot_StickySettings)(nil), "googleadx.BidRequest.AdSlot.StickySettings")
	proto.RegisterType((*BidRequest_BidResponseFeedback)(nil), "googleadx.BidRequest.BidResponseFeedback")
	proto.RegisterType((*BidResponse)(nil), "googleadx.BidResponse")
	proto.RegisterType((*BidResponse_Ad)(nil), "googleadx.BidResponse.Ad")
	proto.RegisterType((*BidResponse_Ad_NativeAd)(nil), "googleadx.BidResponse.Ad.NativeAd")
	proto.RegisterType((*BidResponse_Ad_NativeAd_Image)(nil), "googleadx.BidResponse.Ad.NativeAd.Image")
	proto.RegisterType((*BidResponse_Ad_AdSlot)(nil), "googleadx.BidResponse.Ad.AdSlot")
	proto.RegisterEnum("googleadx.BidRequest_UserDataTreatment", BidRequest_UserDataTreatment_name, BidRequest_UserDataTreatment_value)
	proto.RegisterEnum("googleadx.BidRequest_PublisherType", BidRequest_PublisherType_name, BidRequest_PublisherType_value)
	proto.RegisterEnum("googleadx.BidRequest_Device_DeviceType", BidRequest_Device_DeviceType_name, BidRequest_Device_DeviceType_value)
	proto.RegisterEnum("googleadx.BidRequest_Device_ScreenOrientation", BidRequest_Device_ScreenOrientation_name, BidRequest_Device_ScreenOrientation_value)
	proto.RegisterEnum("googleadx.BidRequest_Video_Placement", BidRequest_Video_Placement_name, BidRequest_Video_Placement_value)
	proto.RegisterEnum("googleadx.BidRequest_Video_VideoPlaybackMethod", BidRequest_Video_VideoPlaybackMethod_name, BidRequest_Video_VideoPlaybackMethod_value)
	proto.RegisterEnum("googleadx.BidRequest_Video_SkippableBidRequestType", BidRequest_Video_SkippableBidRequestType_name, BidRequest_Video_SkippableBidRequestType_value)
	proto.RegisterEnum("googleadx.BidRequest_Video_VideoProtocol", BidRequest_Video_VideoProtocol_name, BidRequest_Video_VideoProtocol_value)
	proto.RegisterEnum("googleadx.BidRequest_Video_VideoFormat", BidRequest_Video_VideoFormat_name, BidRequest_Video_VideoFormat_value)
	proto.RegisterEnum("googleadx.BidRequest_Video_EndCapSupport", BidRequest_Video_EndCapSupport_name, BidRequest_Video_EndCapSupport_value)
	proto.RegisterEnum("googleadx.BidRequest_Video_InventoryType", BidRequest_Video_InventoryType_name, BidRequest_Video_InventoryType_value)
	proto.RegisterEnum("googleadx.BidRequest_Video_CompanionSlot_CreativeFormat", BidRequest_Video_CompanionSlot_CreativeFormat_name, BidRequest_Video_CompanionSlot_CreativeFormat_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_SlotVisibility", BidRequest_AdSlot_SlotVisibility_name, BidRequest_AdSlot_SlotVisibility_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_IFramingState", BidRequest_AdSlot_IFramingState_name, BidRequest_AdSlot_IFramingState_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_IFramingDepth", BidRequest_AdSlot_IFramingDepth_name, BidRequest_AdSlot_IFramingDepth_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_MediationStatus", BidRequest_AdSlot_MediationStatus_name, BidRequest_AdSlot_MediationStatus_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_NonBrowserSource", BidRequest_AdSlot_NonBrowserSource_name, BidRequest_AdSlot_NonBrowserSource_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_Renderer", BidRequest_AdSlot_Renderer_name, BidRequest_AdSlot_Renderer_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_AmpAdRequestType", BidRequest_AdSlot_AmpAdRequestType_name, BidRequest_AdSlot_AmpAdRequestType_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_AllowedAdType", BidRequest_AdSlot_AllowedAdType_name, BidRequest_AdSlot_AllowedAdType_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_MatchingAdData_DirectDeal_DealType", BidRequest_AdSlot_MatchingAdData_DirectDeal_DealType_name, BidRequest_AdSlot_MatchingAdData_DirectDeal_DealType_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_NativeAdTemplate_Fields", BidRequest_AdSlot_NativeAdTemplate_Fields_name, BidRequest_AdSlot_NativeAdTemplate_Fields_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_NativeAdTemplate_LayoutType", BidRequest_AdSlot_NativeAdTemplate_LayoutType_name, BidRequest_AdSlot_NativeAdTemplate_LayoutType_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_AutoRefresh_AutoRefreshSettings_AutoRefreshType", BidRequest_AdSlot_AutoRefresh_AutoRefreshSettings_AutoRefreshType_name, BidRequest_AdSlot_AutoRefresh_AutoRefreshSettings_AutoRefreshType_value)
	proto.RegisterEnum("googleadx.BidRequest_AdSlot_StickySettings_Stickiness", BidRequest_AdSlot_StickySettings_Stickiness_name, BidRequest_AdSlot_StickySettings_Stickiness_value)
	proto.RegisterEnum("googleadx.BidResponse_Ad_AdSlot_ExchangeDealType", BidResponse_Ad_AdSlot_ExchangeDealType_name, BidResponse_Ad_AdSlot_ExchangeDealType_value)
}
