...
type BidRequest struct {
	...
	At *BidRequest_AuctionType `protobuf:"varint,7,opt,name=at,enum=zplay.BidRequest_AuctionType,def=2" json:"at,omitempty"`
...
type BidRequest_Imp_Banner struct {
	...
	Pos *BidRequest_Imp_AdPosition `protobuf:"varint,4,opt,name=pos,enum=zplay.BidRequest_Imp_AdPosition" json:"pos,omitempty"`
	// Blocked banner ad types.
	Btype []BidRequest_Imp_Banner_BannerAdType `protobuf:"varint,5,rep,packed,name=btype,enum=zplay.BidRequest_Imp_Banner_BannerAdType" json:"btype,omitempty"`
	// Blocked creative attributes.
	Battr []CreativeAttribute `protobuf:"varint,6,rep,packed,name=battr,enum=zplay.CreativeAttribute" json:"battr,omitempty"`
	...
	Expdir []BidRequest_Imp_Banner_ExpandableDirection `protobuf:"varint,9,rep,packed,name=expdir,enum=zplay.BidRequest_Imp_Banner_ExpandableDirection" json:"expdir,omitempty"`
	// List of supported API frameworks for this impression.
	// If an API is not explicitly listed, it is assumed not to be supported.
	Api              []BidRequest_Imp_APIFramework `protobuf:"varint,10,rep,packed,name=api,enum=zplay.BidRequest_Imp_APIFramework" json:"api,omitempty"`
	XXX_extensions   map[int32]proto.Extension     `json:"-"`
	XXX_unrecognized []byte                        `json:"-"`
}
...
type BidRequest_Imp_Video struct {
	...
	Linearity *BidRequest_Imp_Video_VideoLinearity `protobuf:"varint,2,opt,name=linearity,enum=zplay.BidRequest_Imp_Video_VideoLinearity" json:"linearity,omitempty"`
	...
	Protocol *BidRequest_Imp_Video_VideoBidResponseProtocol `protobuf:"varint,5,opt,name=protocol,enum=zplay.BidRequest_Imp_Video_VideoBidResponseProtocol" json:"protocol,omitempty"`
	// Array of supported video bid response protocols.
	// At least one supported protocol must be specified.
	Protocols []BidRequest_Imp_Video_VideoBidResponseProtocol `protobuf:"varint,21,rep,packed,name=protocols,enum=zplay.BidRequest_Imp_Video_VideoBidResponseProtocol" json:"protocols,omitempty"`
	...
	// Blocked creative attributes.
	Battr []CreativeAttribute `protobuf:"varint,10,rep,packed,name=battr,enum=zplay.CreativeAttribute" json:"battr,omitempty"`
	...
	Playbackmethod []BidRequest_Imp_Video_VideoPlaybackMethod `protobuf:"varint,15,rep,packed,name=playbackmethod,enum=zplay.BidRequest_Imp_Video_VideoPlaybackMethod" json:"playbackmethod,omitempty"`
	// Supported delivery methods (e.g., streaming, progressive).
	// If none specified, assume all are supported.
	Delivery []BidRequest_Imp_Video_ContentDeliveryMethod `protobuf:"varint,16,rep,packed,name=delivery,enum=zplay.BidRequest_Imp_Video_ContentDeliveryMethod" json:"delivery,omitempty"`
	// Ad position on screen.
	Pos *BidRequest_Imp_AdPosition `protobuf:"varint,17,opt,name=pos,enum=zplay.BidRequest_Imp_AdPosition" json:"pos,omitempty"`
	...
	// List of supported API frameworks for this impression.
	// If an API is not explicitly listed, it is assumed not to be supported.
	Api []BidRequest_Imp_APIFramework `protobuf:"varint,19,rep,packed,name=api,enum=zplay.BidRequest_Imp_APIFramework" json:"api,omitempty"`
	// Supported VAST companion ad types.  Recommended if companion Banner
	// objects are included via the companionad array.
	Companiontype    []BidRequest_Imp_Video_VASTCompanionType `protobuf:"varint,20,rep,packed,name=companiontype,enum=zplay.BidRequest_Imp_Video_VASTCompanionType" json:"companiontype,omitempty"`
	XXX_extensions   map[int32]proto.Extension                `json:"-"`
	XXX_unrecognized []byte                                   `json:"-"`
}
...
type BidRequest_Imp_Native struct {
	...
	// List of supported API frameworks for this impression.
	// If an API is not explicitly listed, it is assumed not to be supported.
	Api []BidRequest_Imp_APIFramework `protobuf:"varint,3,rep,packed,name=api,enum=zplay.BidRequest_Imp_APIFramework" json:"api,omitempty"`
	// Blocked creative attributes.
	Battr            []CreativeAttribute       `protobuf:"varint,4,rep,packed,name=battr,enum=zplay.CreativeAttribute" json:"battr,omitempty"`
	XXX_extensions   map[int32]proto.Extension `json:"-"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
type BidRequest_Imp_Pmp_Deal struct {
	...
	At               *BidRequest_AuctionType   `protobuf:"varint,6,opt,name=at,enum=zplay.BidRequest_AuctionType" json:"at,omitempty"`
	XXX_extensions   map[int32]proto.Extension `json:"-"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
type BidRequest_Content struct {
	...
	Videoquality *BidRequest_Content_VideoQuality `protobuf:"varint,8,opt,name=videoquality,enum=zplay.BidRequest_Content_VideoQuality" json:"videoquality,omitempty"`
	...
	Context *BidRequest_Content_ContentContext `protobuf:"varint,20,opt,name=context,enum=zplay.BidRequest_Content_ContentContext" json:"context,omitempty"`
	...
	Qagmediarating *BidRequest_Content_QAGMediaRating `protobuf:"varint,17,opt,name=qagmediarating,enum=zplay.BidRequest_Content_QAGMediaRating" json:"qagmediarating,omitempty"`
...
type BidRequest_Device struct {
	...
	Connectiontype *BidRequest_Device_ConnectionType `protobuf:"varint,17,opt,name=connectiontype,enum=zplay.BidRequest_Device_ConnectionType" json:"connectiontype,omitempty"`
	// The general type of device.
	Devicetype *BidRequest_Device_DeviceType `protobuf:"varint,18,opt,name=devicetype,enum=zplay.BidRequest_Device_DeviceType" json:"devicetype,omitempty"`
...
type BidRequest_Geo struct {
	...
	Type *BidRequest_Geo_LocationType `protobuf:"varint,9,opt,name=type,enum=zplay.BidRequest_Geo_LocationType" json:"type,omitempty"`
...
type BidResponse struct {
	...
	Nbr              *BidResponse_NoBidReason  `protobuf:"varint,6,opt,name=nbr,enum=zplay.BidResponse_NoBidReason" json:"nbr,omitempty"`
	XXX_extensions   map[int32]proto.Extension `json:"-"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
type BidResponse_SeatBid_Bid struct {
	...
	Attr []CreativeAttribute `protobuf:"varint,11,rep,packed,name=attr,enum=zplay.CreativeAttribute" json:"attr,omitempty"`
...
type NativeRequest struct {
	...
	Layout *NativeRequest_LayoutId `protobuf:"varint,2,opt,name=layout,enum=zplay.NativeRequest_LayoutId" json:"layout,omitempty"`
	// The Ad unit ID of the native ad unit. This corresponds to one of
	// IAB Core-6 native ad units.
	// RECOMMENDED by the OpenRTB Native specification.
	Adunit *NativeRequest_AdUnitId `protobuf:"varint,3,opt,name=adunit,enum=zplay.NativeRequest_AdUnitId" json:"adunit,omitempty"`
...
type NativeRequest_Asset_Image struct {
	...
	Type *NativeRequest_Asset_Image_ImageAssetType `protobuf:"varint,1,opt,name=type,enum=zplay.NativeRequest_Asset_Image_ImageAssetType" json:"type,omitempty"`
...
type NativeRequest_Asset_Data struct {
	...
	// REQUIRED by the OpenRTB Native specification.
	Type *NativeRequest_Asset_Data_DataAssetType `protobuf:"varint,1,req,name=type,enum=zplay.NativeRequest_Asset_Data_DataAssetType" json:"type,omitempty"`
...
func init() {
	proto.RegisterType((*BidRequest)(nil), "zplay.BidRequest")
	proto.RegisterType((*BidRequest_Imp)(nil), "zplay.BidRequest.Imp")
	proto.RegisterType((*BidRequest_Imp_Banner)(nil), "zplay.BidRequest.Imp.Banner")
	proto.RegisterType((*BidRequest_Imp_Video)(nil), "zplay.BidRequest.Imp.Video")
	proto.RegisterType((*BidRequest_Imp_Video_CompanionAd)(nil), "zplay.BidRequest.Imp.Video.CompanionAd")
	proto.RegisterType((*BidRequest_Imp_Native)(nil), "zplay.BidRequest.Imp.Native")
	proto.RegisterType((*BidRequest_Imp_Pmp)(nil), "zplay.BidRequest.Imp.Pmp")
	proto.RegisterType((*BidRequest_Imp_Pmp_Deal)(nil), "zplay.BidRequest.Imp.Pmp.Deal")
	proto.RegisterType((*BidRequest_Site)(nil), "zplay.BidRequest.Site")
	proto.RegisterType((*BidRequest_App)(nil), "zplay.BidRequest.App")
	proto.RegisterType((*BidRequest_Publisher)(nil), "zplay.BidRequest.Publisher")
	proto.RegisterType((*BidRequest_Content)(nil), "zplay.BidRequest.Content")
	proto.RegisterType((*BidRequest_Producer)(nil), "zplay.BidRequest.Producer")
	proto.RegisterType((*BidRequest_Device)(nil), "zplay.BidRequest.Device")
	proto.RegisterType((*BidRequest_Geo)(nil), "zplay.BidRequest.Geo")
	proto.RegisterType((*BidRequest_User)(nil), "zplay.BidRequest.User")
	proto.RegisterType((*BidRequest_Data)(nil), "zplay.BidRequest.Data")
	proto.RegisterType((*BidRequest_Data_Segment)(nil), "zplay.BidRequest.Data.Segment")
	proto.RegisterType((*BidRequest_Regs)(nil), "zplay.BidRequest.Regs")
	proto.RegisterType((*BidResponse)(nil), "zplay.BidResponse")
	proto.RegisterType((*BidResponse_SeatBid)(nil), "zplay.BidResponse.SeatBid")
	proto.RegisterType((*BidResponse_SeatBid_Bid)(nil), "zplay.BidResponse.SeatBid.Bid")
	proto.RegisterType((*NativeRequest)(nil), "zplay.NativeRequest")
	proto.RegisterType((*NativeRequest_Asset)(nil), "zplay.NativeRequest.Asset")
	proto.RegisterType((*NativeRequest_Asset_Title)(nil), "zplay.NativeRequest.Asset.Title")
	proto.RegisterType((*NativeRequest_Asset_Image)(nil), "zplay.NativeRequest.Asset.Image")
	proto.RegisterType((*NativeRequest_Asset_Data)(nil), "zplay.NativeRequest.Asset.Data")
	proto.RegisterType((*NativeResponse)(nil), "zplay.NativeResponse")
	proto.RegisterType((*NativeResponse_Link)(nil), "zplay.NativeResponse.Link")
	proto.RegisterType((*NativeResponse_Asset)(nil), "zplay.NativeResponse.Asset")
	proto.RegisterType((*NativeResponse_Asset_Title)(nil), "zplay.NativeResponse.Asset.Title")
	proto.RegisterType((*NativeResponse_Asset_Image)(nil), "zplay.NativeResponse.Asset.Image")
	proto.RegisterType((*NativeResponse_Asset_Data)(nil), "zplay.NativeResponse.Asset.Data")
	proto.RegisterType((*NativeResponse_Asset_Video)(nil), "zplay.NativeResponse.Asset.Video")
	proto.RegisterEnum("zplay.ContentCategory", ContentCategory_name, ContentCategory_value)
	proto.RegisterEnum("zplay.CreativeAttribute", CreativeAttribute_name, CreativeAttribute_value)
	proto.RegisterEnum("zplay.BidRequest_AuctionType", BidRequest_AuctionType_name, BidRequest_AuctionType_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_AdPosition", BidRequest_Imp_AdPosition_name, BidRequest_Imp_AdPosition_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_APIFramework", BidRequest_Imp_APIFramework_name, BidRequest_Imp_APIFramework_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_Banner_BannerAdType", BidRequest_Imp_Banner_BannerAdType_name, BidRequest_Imp_Banner_BannerAdType_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_Banner_ExpandableDirection", BidRequest_Imp_Banner_ExpandableDirection_name, BidRequest_Imp_Banner_ExpandableDirection_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_Video_VideoLinearity", BidRequest_Imp_Video_VideoLinearity_name, BidRequest_Imp_Video_VideoLinearity_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_Video_VideoBidResponseProtocol", BidRequest_Imp_Video_VideoBidResponseProtocol_name, BidRequest_Imp_Video_VideoBidResponseProtocol_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_Video_VideoPlaybackMethod", BidRequest_Imp_Video_VideoPlaybackMethod_name, BidRequest_Imp_Video_VideoPlaybackMethod_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_Video_VideoStartDelay", BidRequest_Imp_Video_VideoStartDelay_name, BidRequest_Imp_Video_VideoStartDelay_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_Video_VASTCompanionType", BidRequest_Imp_Video_VASTCompanionType_name, BidRequest_Imp_Video_VASTCompanionType_value)
	proto.RegisterEnum("zplay.BidRequest_Imp_Video_ContentDeliveryMethod", BidRequest_Imp_Video_ContentDeliveryMethod_name, BidRequest_Imp_Video_ContentDeliveryMethod_value)
	proto.RegisterEnum("zplay.BidRequest_Content_VideoQuality", BidRequest_Content_VideoQuality_name, BidRequest_Content_VideoQuality_value)
	proto.RegisterEnum("zplay.BidRequest_Content_ContentContext", BidRequest_Content_ContentContext_name, BidRequest_Content_ContentContext_value)
	proto.RegisterEnum("zplay.BidRequest_Content_QAGMediaRating", BidRequest_Content_QAGMediaRating_name, BidRequest_Content_QAGMediaRating_value)
	proto.RegisterEnum("zplay.BidRequest_Device_DeviceType", BidRequest_Device_DeviceType_name, BidRequest_Device_DeviceType_value)
	proto.RegisterEnum("zplay.BidRequest_Device_ConnectionType", BidRequest_Device_ConnectionType_name, BidRequest_Device_ConnectionType_value)
	proto.RegisterEnum("zplay.BidRequest_Geo_LocationType", BidRequest_Geo_LocationType_name, BidRequest_Geo_LocationType_value)
	proto.RegisterEnum("zplay.BidRequest_User_Gender", BidRequest_User_Gender_name, BidRequest_User_Gender_value)
	proto.RegisterEnum("zplay.BidResponse_NoBidReason", BidResponse_NoBidReason_name, BidResponse_NoBidReason_value)
	proto.RegisterEnum("zplay.NativeRequest_LayoutId", NativeRequest_LayoutId_name, NativeRequest_LayoutId_value)
	proto.RegisterEnum("zplay.NativeRequest_AdUnitId", NativeRequest_AdUnitId_name, NativeRequest_AdUnitId_value)
	proto.RegisterEnum("zplay.NativeRequest_Asset_Image_ImageAssetType", NativeRequest_Asset_Image_ImageAssetType_name, NativeRequest_Asset_Image_ImageAssetType_value)
	proto.RegisterEnum("zplay.NativeRequest_Asset_Data_DataAssetType", NativeRequest_Asset_Data_DataAssetType_name, NativeRequest_Asset_Data_DataAssetType_value)
}
